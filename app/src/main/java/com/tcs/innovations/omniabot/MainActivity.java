...
public class MainActivity extends AppCompatActivity {
    ...
    private String clientId = "omnia_look";
    ...
    private LinearLayout expressionView;

    public static String happinessFactor = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expressionView = (LinearLayout) findViewById(R.id.expression_container);
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        public void onNewItem(int faceId, Face face) {
            ...
            try{
                Log.i(TAG, String.format("NewItem Happiness: %.2f", face.getIsSmilingProbability()) );
                Emoji emoji = new Emoji();
                emoji.setExpression(face);
                publishMessage(emoji.getEmojiChar(), topic_expression);
            }catch (Exception e){
                e.printStackTrace();
            }
        }
        ...
        public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
            try{
                Log.i(TAG, String.format("Update Happiness: %.2f", face.getIsSmilingProbability()) );
                Emoji emoji = new Emoji();
                emoji.setExpression(face);
                publishMessage(emoji.getEmojiChar(), topic_expression);
            }catch (Exception e){
    ...
    private void publishMessage(String payload, String topic){
        ...
        try {
            encodedPayload = payload.getBytes("UTF-16");
